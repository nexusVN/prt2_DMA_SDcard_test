...
BYTE wait_ready (void)
{
    ...
    Timer2 = 50;    /* Wait for ready in timeout of 50ms */
//    rcvr_spi();
    do
        res = rcvr_spi();
...
)
{
    BYTE n;
    /* Send command packet */
    xmit_spi_my(cmd);                        /* Command */
    xmit_spi_my((BYTE)(arg >> 24));        /* Argument[31..24] */
    xmit_spi_my((BYTE)(arg >> 16));        /* Argument[23..16] */
    xmit_spi_my((BYTE)(arg >> 8));            /* Argument[15..8] */
    xmit_spi_my((BYTE)arg);                /* Argument[7..0] */
    n = 0xff;
    xmit_spi_my(n);
}
